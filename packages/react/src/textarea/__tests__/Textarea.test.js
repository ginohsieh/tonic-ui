...
describe('Textarea', () => {
  ...
  it('should render correctly with value attribute', () => {
    const { container } = render(
      <Textarea data-testid="textarea" value="Sample text" />
    );
    const textarea = screen.getByTestId('textarea');
    expect(textarea.value).toBe('Sample text');
  });

  it('should render correctly with placeholder attribute', () => {
    render(
      <Textarea data-testid="textarea" placeholder="Enter text here" />
    );
    const textarea = screen.getByTestId('textarea');
    expect(textarea).toHaveAttribute('placeholder', 'Enter text here');
  });

  it('should render correctly with name attribute', () => {
    render(
      <Textarea data-testid="textarea" name="comments" />
    );
    const textarea = screen.getByTestId('textarea');
  ...
  it('should render correctly with maxLength attribute', () => {
    render(
      <Textarea data-testid="textarea" maxLength={100} />
    );
    const textarea = screen.getByTestId('textarea');
